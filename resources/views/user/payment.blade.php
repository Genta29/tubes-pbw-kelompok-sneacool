    ...
    <div class="bg">
        <div class="section" style="background-color: aliceblue; height: 100%">
            <div class="container mt-4">
                ...
                <form method="POST" action="{{ route('customization.Payment', ['customization' => $customization->id]) }}" enctype="multipart/form-data">
                    @csrf

                    <input type="hidden" name="customisasi_id" value="{{ $customization->id }}">
